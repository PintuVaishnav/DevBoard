...
const sidebarVariants = cva(
  "flex h-full w-full flex-col overflow-hidden bg-sidebar text-sidebar-foreground",
  {
    variants: {
      variant: {
        default: "border-sidebar-border bg-sidebar text-sidebar-foreground",
        inset: "border-sidebar-border bg-sidebar text-sidebar-foreground",
      },
      side: {
        left: "",
        right: "",
...
>(({ className, showIcon = false, ...props }, ref) => (
  ...
  >
    ...
    <div
      className="h-4 flex-1 max-w-[--skeleton-width] bg-sidebar-primary/10 rounded-sm"
